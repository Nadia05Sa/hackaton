          ...
          <CardContent sx={{ p: 3 }}>
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}><FormLabel required>Dirección</FormLabel><TextField fullWidth {...register("direccion")} error={!!errors.direccion} InputProps={{ sx: { height: 48 } }} sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2, backgroundColor: colors.background } }} /></Grid>
                ...
                <Grid item xs={12} sm={6}><FormLabel>Horario</FormLabel><TextField fullWidth {...register("horario")} InputProps={{ sx: { height: 48 } }} sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2, backgroundColor: colors.background } }} /></Grid>
                <Grid item xs={12} sm={6}><FormLabel>Costo entrada</FormLabel><TextField fullWidth type="number" {...register("costoEntrada")} InputProps={{ sx: { height: 48 } }} sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2, backgroundColor: colors.background } }} /></Grid>
              </Grid>
